package com.joinwe.carcloud.wechatapplet.constant;

import com.joinwe.carcloud.wechatapplet.WeChatAppletProperties;
...
public final class WeChatConstant {
    ...
    public final String METHOD_TYPE_POST = "POST";
